<div class="w-full block mt-8">
    <div class="flex flex-wrap sm:flex-no-wrap justify-between">
        <div class="w-full bg-white-200 text-center border border-gray-300 px-8 py-6 rounded">
            <h3 class="text-gray-700 uppercase font-bold">
                <span class="text-4xl">{{ sprintf("%02d", $teacher->classes_count) }}</span>
                <br />
                <span class="leading-tight">Class(es)</span>
            </h3>
        </div>
        <div class="w-full bg-white-200 text-center border border-gray-300 px-8 py-6 mx-0 sm:mx-6 my-4 sm:my-0 rounded">
            <h3 class="text-gray-700 uppercase font-bold">
                <span class="text-4xl">{{ sprintf("%02d", $teacher->subjects_count) }}</span>
                <br />
                <span class="leading-tight">Subject(s)</span>
            </h3>
        </div>
        <div class="w-full bg-white-200 text-center border border-gray-300 px-8 py-6 rounded">
            <h3 class="text-gray-700 uppercase font-bold">
                ...
                <br />
                <span class="leading-tight">Student(s)</span>
            </h3>
        </div>
    </div>
</div>
            ...
            <div class="flex flex-wrap items-center">
                @foreach ($teacher->classes as $class)
                    <div class="w-full sm:w-1/2 text-center border border-gray-200 rounded">
                        ...
                        <a href="{{ route('teacher.attendance.create',$class->id) }}" class="bg-gray-200 inline-block mb-4 text-xs text-gray-600 uppercase font-semibold px-4 py-2 border border-gray-200 rounded">Attendance</a>
                    </div>
                @endforeach
            </div>
        </div>
